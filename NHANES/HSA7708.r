...
X = 'Food'
Aa = c('Gender', 'Age', 'Race')
Ab = c('Gender', 'Age', 'Race', 'Education', 'Income')
Y1 = 'Hypertension'
F1a = as.formula(paste(Y1, ' ~ ', paste(X, '+', paste(Aa, collapse = ' + ')), sep = ''))
M1_C = svyglm(F1a, design = S, data = D, family = poisson()) # Log link [Y = ln(DV)] (aka: Log-Linear) with poisson error (aka: Poisson regression)
F1b = as.formula(paste(Y1, ' ~ ', paste(X, '+', paste(Ab, collapse = ' + ')), sep = ''))
M1_A = svyglm(F1b, design = S, data = D, family = poisson()) # Log link [Y = ln(DV)] (aka: Log-Linear) with poisson error (aka: Poisson regression)
Y2 = 'Hyperlipidemia'
F2a = as.formula(paste(Y2, ' ~ ', paste(X, '+', paste(Aa, collapse = ' + ')), sep = ''))
M2_C = svyglm(F2a, design = S, data = D, family = poisson()) # Log link [Y = ln(DV)] (aka: Log-Linear) with poisson error (aka: Poisson regression)
F2b = as.formula(paste(Y2, ' ~ ', paste(X, '+', paste(Ab, collapse = ' + ')), sep = ''))
M2_A = svyglm(F2b, design = S, data = D, family = poisson()) # Log link [Y = ln(DV)] (aka: Log-Linear) with poisson error (aka: Poisson regression)
Y3 = 'Diabetes'
F3a = as.formula(paste(Y3, ' ~ ', paste(X, '+', paste(Aa, collapse = ' + ')), sep = ''))
M3_C = svyglm(F3a, design = S, data = D, family = poisson()) # Log link [Y = ln(DV)] (aka: Log-Linear) with poisson error (aka: Poisson regression)
F3b = as.formula(paste(Y3, ' ~ ', paste(X, '+', paste(Ab, collapse = ' + ')), sep = ''))
M3_A = svyglm(F3b, design = S, data = D, family = poisson()) # Log link [Y = ln(DV)] (aka: Log-Linear) with poisson error (aka: Poisson regression)

### Export to Summary File
sink(file = 'summary.txt', append = TRUE, type = 'output')
cat('Generalized Regression Models using Survey Weights', '\n\n', file = 'summary.txt', append = TRUE)
cat('Title:\n', Y1, 'and', X, 'adjusted by', Aa, '\n', file = 'summary.txt', append = TRUE)
summary(M1_C)
cat('Title:\n', Y1, 'and', X, 'adjusted by', Ab, '\n', file = 'summary.txt', append = TRUE)
summary(M1_A)
cat('Title:\n', Y2, 'and', X, 'adjusted by', Aa, '\n', file = 'summary.txt', append = TRUE)
summary(M2_C)
cat('Title:\n', Y2, 'and', X, 'adjusted by', Ab, '\n', file = 'summary.txt', append = TRUE)
summary(M2_A)
cat('Title:\n', Y3, 'and', X, 'adjusted by', Aa, '\n', file = 'summary.txt', append = TRUE)
summary(M3_C)
cat('Title:\n', Y3, 'and', X, 'adjusted by', Ab, '\n', file = 'summary.txt', append = TRUE)
summary(M3_A)
cat(c('####################', '\n\n'), file = 'summary.txt', append = TRUE)
sink()